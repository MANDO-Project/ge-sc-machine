...
class LINE_NODE_CLASSIFIER_CONFIG_UNCHECKED_LOW_LEVEL_CALLS(BaseSettings):
...
class LINE_NODE_CLASSIFIER_CONFIG_REENTRANCY(BaseSettings):
    CHECKPOINT = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/han_fold_0.pth')
    COMPRESSED_GRAPH = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/buggy_curated/cfg_cg_compressed_graphs.gpickle')
    DATASET = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/buggy_curated')
    feature_extractor = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/matrix_line_dim128_of_core_graph_of_reentrancy_cfg_cg_buggy_curated.pkl')

class LINE_NODE_CLASSIFIER_CONFIG_ACCESS_CONTRO(BaseSettings):
    CHECKPOINT = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/han_fold_0.pth')
    COMPRESSED_GRAPH = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/buggy_curated/cfg_cg_compressed_graphs.gpickle')
    DATASET = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/buggy_curated')
    feature_extractor = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/matrix_line_dim128_of_core_graph_of_reentrancy_cfg_cg_buggy_curated.pkl')

class LINE_NODE_CLASSIFIER_CONFIG_ARITHMETIC(BaseSettings):
    CHECKPOINT = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/han_fold_0.pth')
    COMPRESSED_GRAPH = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/buggy_curated/cfg_cg_compressed_graphs.gpickle')
    DATASET = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/buggy_curated')
    feature_extractor = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/matrix_line_dim128_of_core_graph_of_reentrancy_cfg_cg_buggy_curated.pkl')

class LINE_NODE_CLASSIFIER_CONFIG_DENIAL_OF_SERVICE(BaseSettings):
    CHECKPOINT = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/han_fold_0.pth')
    COMPRESSED_GRAPH = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/buggy_curated/cfg_cg_compressed_graphs.gpickle')
    DATASET = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/buggy_curated')
    feature_extractor = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/matrix_line_dim128_of_core_graph_of_reentrancy_cfg_cg_buggy_curated.pkl')

class LINE_NODE_CLASSIFIER_CONFIG_FRONT_RUNNING(BaseSettings):
    CHECKPOINT = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/han_fold_0.pth')
    COMPRESSED_GRAPH = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/buggy_curated/cfg_cg_compressed_graphs.gpickle')
    DATASET = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/buggy_curated')
    feature_extractor = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/matrix_line_dim128_of_core_graph_of_reentrancy_cfg_cg_buggy_curated.pkl')

class LINE_NODE_CLASSIFIER_CONFIG_TIME_MANIPULATION(BaseSettings):
    CHECKPOINT = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/han_fold_0.pth')
    COMPRESSED_GRAPH = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/buggy_curated/cfg_cg_compressed_graphs.gpickle')
    DATASET = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/buggy_curated')
    feature_extractor = join(BASE_PATH, '../models/node_classification/cfg_cg/line/reentrancy/matrix_line_dim128_of_core_graph_of_reentrancy_cfg_cg_buggy_curated.pkl')
...
class Settings_ACCESS_CONTRO(BaseSettings):
    SERVER_NAME = 'sco'
    VERSION: str = 'v1.0.0'
    ...
    LINE = LINE_NODE_CLASSIFIER_CONFIG_ACCESS_CONTRO()
...
class Settings_ARITHMETIC(BaseSettings):
    ...
    TASK: str = 'detection'
    PREFIX: str = f'/{VERSION}/{SERVICE}/{TASK}'
    LINE = LINE_NODE_CLASSIFIER_CONFIG_ARITHMETIC()
    API_KEY = 'MqQVfJ6Fq1umZnUI7ZuaycciCjxi3gM0'
    DEVICE: str = 'cuda:0' if check_gpu() else 'cpu'
    class Config:
        env_file = '.env'
...
class Settings_DENIAL_OF_SERVICE(BaseSettings):
    ...
    TASK: str = 'detection'
    PREFIX: str = f'/{VERSION}/{SERVICE}/{TASK}'
    LINE = LINE_NODE_CLASSIFIER_CONFIG_DENIAL_OF_SERVICE()
    API_KEY = 'MqQVfJ6Fq1umZnUI7ZuaycciCjxi3gM0'
    DEVICE: str = 'cuda:0' if check_gpu() else 'cpu'
    class Config:
        env_file = '.env'  
...
class Settings_FRONT_RUNNING(BaseSettings):
    ...
    TASK: str = 'detection'
    PREFIX: str = f'/{VERSION}/{SERVICE}/{TASK}'
    LINE = LINE_NODE_CLASSIFIER_CONFIG_FRONT_RUNNING()
    API_KEY = 'MqQVfJ6Fq1umZnUI7ZuaycciCjxi3gM0'
    DEVICE: str = 'cuda:0' if check_gpu() else 'cpu'
    class Config:
        env_file = '.env'
...
class Settings_REENTRANCY(BaseSettings):
    ...
    TASK: str = 'detection'
    PREFIX: str = f'/{VERSION}/{SERVICE}/{TASK}'
    LINE = LINE_NODE_CLASSIFIER_CONFIG_REENTRANCY()
    API_KEY = 'MqQVfJ6Fq1umZnUI7ZuaycciCjxi3gM0'
    DEVICE: str = 'cuda:0' if check_gpu() else 'cpu'
    class Config:
        env_file = '.env'   
...
class Settings_TIME_MANIPULATION(BaseSettings):
    ...
    TASK: str = 'detection'
    PREFIX: str = f'/{VERSION}/{SERVICE}/{TASK}'
    LINE = LINE_NODE_CLASSIFIER_CONFIG_TIME_MANIPULATION()
    API_KEY = 'MqQVfJ6Fq1umZnUI7ZuaycciCjxi3gM0'
    DEVICE: str = 'cuda:0' if check_gpu() else 'cpu'
    class Config:
        env_file = '.env'
...
class Settings_UNCHECKED_LOW_LEVEL_CALLS(BaseSettings):
    ...
    TASK: str = 'detection'
    PREFIX: str = f'/{VERSION}/{SERVICE}/{TASK}'
    LINE = LINE_NODE_CLASSIFIER_CONFIG_UNCHECKED_LOW_LEVEL_CALLS()
    API_KEY = 'MqQVfJ6Fq1umZnUI7ZuaycciCjxi3gM0'
    DEVICE: str = 'cuda:0' if check_gpu() else 'cpu'
    class Config:
        env_file = '.env'   

settings_access_contro = Settings_ACCESS_CONTRO()
